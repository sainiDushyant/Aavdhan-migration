...
import '../../../../../../../../@core/scss/scss/react/libs/flatpickr/flatpickr.scss';

import Nouislider from 'nouislider-react';
import '../../../../../../../../@core/scss/scss/react/libs/noui-slider/noui-slider.scss';
...
const DtrCommand = (props) => {
  ...
  const [executeDLMSCommand, DLMSCommandResponse] =
  ...
  useEffect(() => {
    if (DLMSCommandResponse.status === 'fulfilled') {
      const statusCode = DLMSCommandResponse.data.responseCode;
      const response = DLMSCommandResponse.data;
